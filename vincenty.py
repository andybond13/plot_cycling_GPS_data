...
class vincenty_inverse:
    def __init__(self,coord1,coord2,maxIter=200,tol=10**-12):
        ...
        if phi_1 == phi_2 and L_1 == L_2:
            ...
            self.mi=self.m*0.000621371          # output distance in miles
            self.nm=self.mi*(6080.20/5280)      # output distance in nautical miles
            self.ft=self.mi*5280                     # output distance in feet
            self.inch=self.ft*12                    # output distance in inches
            self.yd=self.ft/3                      # output distance in yards
            return
